...
This is a [**Lean JS App Starter (LJAS)**](https://github.com/mattlean/lean-js-app-starter) starter project for a vanilla JavaScript application targeted for web browsers.

_If you need TypeScript, then use the [Basic Browser starter (TypeScript)](https://github.com/mattlean/lean-js-app-starter/tree/v1.1.0/starters/basic-browser-ts) instead._
...
First, [**download the starter project's ZIP file**](https://github.com/mattlean/lean-js-app-starter/releases/download/v1.1.0/leaflet-playground_1-1-0.zip) and extract it.
